...
<main class="room-layout">
  <section class="glass panel">
    <h2>بازیکنان اتاق</h2>
    <ul id="players"></ul>
    <label id="roundTargetWrap" class="hidden">تعداد امتیاز برای برد بازی
      <input id="roundTarget" type="number" min="1" max="20" value="7">
    </label>
  ...
  <section class="glass panel game-section">
    ...
    <div id="teamNaming" class="hidden">
      <h3>نام‌گذاری تیم</h3>
      <div class="team-name-row team-a hidden">
